...
<MobileElementEntity>
   ...
   <name>asnbContinueBtn</name>
   <tag></tag>
   <elementGuidId>f79f5b4c-c4c7-45ff-8959-dafe2a641548</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (contains(@text, 'Continue') or contains(., 'Continue'))]</locator>
