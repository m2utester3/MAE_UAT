...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Monthly statement</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Monthly statement' or . = 'Monthly statement')]</locator>
