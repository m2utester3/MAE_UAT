...
<MobileElementEntity>
   ...
   <name>zestiAppl_bodyButtonText</name>
   <tag></tag>
...
investment account</value>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Rewards all year
long with a
Shariah-compliant
investment account' or . = 'Rewards all year
long with a
Shariah-compliant
investment account')]</locator>
