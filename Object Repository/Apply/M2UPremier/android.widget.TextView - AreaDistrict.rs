...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - AreaDistrict</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Area/District' or . = 'Area/District')]</locator>
