...
<MobileElementEntity>
   ...
   <name>applyFD_fdSSelectedConfirmation</name>
   <tag></tag>
   <elementGuidId>f2993373-532d-45a2-b224-b6361c83b6b3</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${fdType}' or . = '${fdType}')]</locator>
