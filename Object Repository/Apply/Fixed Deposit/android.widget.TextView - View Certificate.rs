...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - View Certificate</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'View Certificate' or . = 'View Certificate')]</locator>
