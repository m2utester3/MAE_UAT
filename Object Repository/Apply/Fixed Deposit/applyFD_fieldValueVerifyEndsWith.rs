...
<MobileElementEntity>
   ...
   <name>applyFD_fieldValueVerifyEndsWith</name>
   <tag></tag>
   <elementGuidId>4fe6e0e6-a98b-49ba-a6ea-c1f2f42a42c1</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (ends-with(@text, '${value}') or ends-with(., '${value}'))]</locator>
