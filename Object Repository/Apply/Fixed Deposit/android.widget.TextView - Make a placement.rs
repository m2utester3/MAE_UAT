...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Make a placement</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Make a placement' or . = 'Make a placement')]</locator>
