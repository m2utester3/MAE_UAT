...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Employers name</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Employer’s name' or . = 'Employer’s name')]</locator>
