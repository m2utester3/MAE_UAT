...
<MobileElementEntity>
   ...
   <name>applyFD_minAmountErrorMessage</name>
   <tag></tag>
   <elementGuidId>2da5b9d1-a3d7-4c64-bfde-95f3b8e06deb</elementGuidId>
   ...
   <webElementProperties>
      ...
      <name>text</name>
      <type>Main</type>
      <value>Minimum principal amount is 
RM</value>
   </webElementProperties>
   <webElementProperties>
      <isSelected>false</isSelected>
   ...
   <locator>//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[2]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.widget.TextView[1][count(. | //*[@class = 'android.widget.TextView' and (starts-with(@text, 'Minimum principal amount is 
RM') or starts-with(., 'Minimum principal amount is 
RM'))]) = count(//*[@class = 'android.widget.TextView' and (starts-with(@text, 'Minimum principal amount is 
RM') or starts-with(., 'Minimum principal amount is 
RM'))])]</locator>
