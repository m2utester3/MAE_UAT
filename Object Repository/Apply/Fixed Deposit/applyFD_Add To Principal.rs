...
<MobileElementEntity>
   ...
   <name>applyFD_Add To Principal</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Add To Principal' or . = 'Add To Principal')]</locator>
