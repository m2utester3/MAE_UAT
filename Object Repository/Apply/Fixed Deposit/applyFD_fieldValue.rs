...
<MobileElementEntity>
   ...
   <name>applyFD_fieldValue</name>
   <tag></tag>
   <elementGuidId>e932cedc-398d-402d-8ec6-dae05da0a378</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (starts-with(@text, '${value}') or starts-with(., '${value}'))]</locator>
