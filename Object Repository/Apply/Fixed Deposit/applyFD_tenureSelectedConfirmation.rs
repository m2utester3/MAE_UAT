...
<MobileElementEntity>
   ...
   <name>applyFD_tenureSelectedConfirmation</name>
   <tag></tag>
   <elementGuidId>5625dce3-274e-445b-aab9-b4b8260f2389</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${tenure}' or . = '${tenure}')]</locator>
