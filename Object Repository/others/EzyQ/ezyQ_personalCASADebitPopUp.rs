...
<MobileElementEntity>
   ...
   <name>ezyQ_personalCASADebitPopUp</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Image' and (@text = 'Personal current/savings account and debit card' or . = 'Personal current/savings account and debit card')]</locator>
