...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Maybank EzyQ (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Maybank EzyQ' or . = 'Maybank EzyQ')]</locator>
