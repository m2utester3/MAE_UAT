...
<MobileElementEntity>
   ...
   <name>ezyQ_Make an appointment</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Make an appointment' or . = 'Make an appointment')]</locator>
