...
<MobileElementEntity>
   ...
   <name>casaAccDetail_busTicketsButton</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Bus Tickets' or . = 'Bus Tickets')]</locator>
