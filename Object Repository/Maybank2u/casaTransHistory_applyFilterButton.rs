...
<MobileElementEntity>
   ...
   <name>casaTransHistory_applyFilterButton</name>
   <tag></tag>
   <elementGuidId>e64bc70b-40bc-4bf1-8b56-da60acb17762</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (contains(@text, 'Apply Filter') or contains(., 'Apply Filter'))]</locator>
