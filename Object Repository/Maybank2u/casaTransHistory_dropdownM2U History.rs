...
<MobileElementEntity>
   ...
   <name>casaTransHistory_dropdownM2U History</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'M2U History' or . = 'M2U History')]</locator>
