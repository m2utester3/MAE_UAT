...
<MobileElementEntity>
   ...
   <name>casaAccDetail_flightTicketsButton</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Flight Tickets' or . = 'Flight Tickets')]</locator>
