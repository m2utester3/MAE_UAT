...
<MobileElementEntity>
   ...
   <name>casaAccDetail_movieTicketsButton</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Movie Tickets' or . = 'Movie Tickets')]</locator>
