...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Add Another Card</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Add Another Card' or . = 'Add Another Card')]</locator>
