...
<MobileElementEntity>
   ...
   <name>payCardOutstandingAmountValue</name>
   <tag></tag>
   <elementGuidId>840d01b8-e089-40c4-8256-59dfd9725631</elementGuidId>
   ...
   <locator>//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.widget.FrameLayout[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.widget.FrameLayout[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.widget.ScrollView[1]/android.view.ViewGroup[1]/android.view.ViewGroup[2]/android.widget.TextView[2][count(. | //*[@class = 'android.widget.TextView' and (starts-with(@text, 'RM ') or starts-with(., 'RM ')) and (not(contains(@text, ' RM -')) or not(contains(., ' RM -')))]) = count(//*[@class = 'android.widget.TextView' and (starts-with(@text, 'RM ') or starts-with(., 'RM ')) and (not(contains(@text, ' RM -')) or not(contains(., ' RM -')))])]</locator>
