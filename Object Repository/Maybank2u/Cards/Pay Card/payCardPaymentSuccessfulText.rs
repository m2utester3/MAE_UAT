...
<MobileElementEntity>
   ...
   <name>payCardPaymentSuccessfulText</name>
   <tag></tag>
   <elementGuidId>aa151531-404f-42c3-854d-c4d22bd28f3e</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${resultText}' or . = '${resultText}')]</locator>
