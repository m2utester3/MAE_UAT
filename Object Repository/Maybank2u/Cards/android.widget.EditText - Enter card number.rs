...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Enter card number</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Enter card number' or . = 'Enter card number')]</locator>
