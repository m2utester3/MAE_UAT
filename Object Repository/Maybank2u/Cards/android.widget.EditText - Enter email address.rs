...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Enter email address</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Enter email address' or . = 'Enter email address')]</locator>
