...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Available balance</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Available balance' or . = 'Available balance')]</locator>
