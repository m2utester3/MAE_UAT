...
<MobileElementEntity>
   ...
   <name>casaAccDetail_sama2LokalButton</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Sama2 Lokal' or . = 'Sama2 Lokal')]</locator>
