...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - FEA Requirement</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'FEA Requirement' or . = 'FEA Requirement')]</locator>
