...
<MobileElementEntity>
   ...
   <name>overseaTransferBakong_fieldText</name>
   <tag></tag>
   <elementGuidId>2e4fd91a-6ec4-468a-9745-64dd0cda8b21</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${fieldText}' or . = '${fieldText}')]</locator>
