...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>6ff92c1e-7888-4445-a84d-33c45d57d5a0</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (contains(@text, '${accNo}') or contains(., '${accNo}'))]</locator>
