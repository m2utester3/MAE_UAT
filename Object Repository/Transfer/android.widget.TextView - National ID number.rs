...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - National ID number</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'National ID number' or . = 'National ID number')]</locator>
