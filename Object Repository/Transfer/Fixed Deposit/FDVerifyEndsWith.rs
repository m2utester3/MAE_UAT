...
<MobileElementEntity>
   ...
   <name>FDVerifyEndsWith</name>
   <tag></tag>
   <elementGuidId>c1c81f10-391d-4032-b3a6-2610fce916ed</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (ends-with(@text, '% p.a.') or ends-with(., '% p.a.'))]</locator>
