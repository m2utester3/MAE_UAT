...
<MobileElementEntity>
   ...
   <name>overseaTransferBakong_receiverAccountName</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Laing Moam' or . = 'Laing Moam')]</locator>
