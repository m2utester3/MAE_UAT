...
<MobileElementEntity>
   ...
   <name>LoanVerifyEndsWith</name>
   <tag></tag>
   <elementGuidId>25fe4323-96fc-4b39-b4fa-44a3814d4f81</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (ends-with(@text, '${endsWith}') or ends-with(., '${endsWith}'))]</locator>
