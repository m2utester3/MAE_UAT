...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - National ID</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'National ID' or . = 'National ID')]</locator>
