...
<MobileElementEntity>
   ...
   <name>Enter New Password</name>
   <tag></tag>
   <elementGuidId>0dc3fe24-55fb-40c9-bf78-ae5d2b7ae3af</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Enter new password' or . = 'Enter new password')]</locator>
