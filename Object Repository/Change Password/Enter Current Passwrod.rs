...
<MobileElementEntity>
   ...
   <name>Enter Current Passwrod</name>
   <tag></tag>
   <elementGuidId>05103240-eec9-4473-af1a-4f43cea1d39a</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Enter current password' or . = 'Enter current password')]</locator>
