...
<MobileElementEntity>
   ...
   <name>qrPayMerchant_enterPromoInput</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Enter Promo' or . = 'Enter Promo')]</locator>
