...
<MobileElementEntity>
   ...
   <name>qrPayMerchant_merchantName</name>
   <tag></tag>
   <elementGuidId>fce5e7b4-20d9-45b4-9e6b-52c4a6d4f505</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${merchantName}' or . = '${merchantName}')]</locator>
