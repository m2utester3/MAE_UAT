...
<MobileElementEntity>
   ...
   <name>qrPayMerchant_applyPromoButton</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Apply Promo' or . = 'Apply Promo')]</locator>
