...
<MobileElementEntity>
   ...
   <name>tabungBooster_spareChangeBooster summary</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Booster summary:' or . = 'Booster summary:')]</locator>
