...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Fund amount</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Fund amount' or . = 'Fund amount')]</locator>
