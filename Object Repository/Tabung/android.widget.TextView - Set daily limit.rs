...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Set daily limit</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Set daily limit' or . = 'Set daily limit')]</locator>
