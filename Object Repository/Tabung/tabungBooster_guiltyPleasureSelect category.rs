...
<MobileElementEntity>
   ...
   <name>tabungBooster_guiltyPleasureSelect category</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Select category' or . = 'Select category')]</locator>
