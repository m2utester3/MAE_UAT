...
<MobileElementEntity>
   ...
   <name>tabungBooster_ScanSave</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Scan &amp; Save' or . = 'Scan &amp; Save')]</locator>
