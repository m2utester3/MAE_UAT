...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Guilty Pleasure</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Guilty Pleasure' or . = 'Guilty Pleasure')]</locator>
