...
<MobileElementEntity>
   ...
   <name>tabungBooster_Spare Change</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Spare Change' or . = 'Spare Change')]</locator>
