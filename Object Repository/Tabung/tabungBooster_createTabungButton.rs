...
<MobileElementEntity>
   ...
   <name>tabungBooster_createTabungButton</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Create Tabung' or . = 'Create Tabung')]</locator>
