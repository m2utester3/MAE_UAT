...
<MobileElementEntity>
   ...
   <name>duitNowRTPConfirmPayerMobileNoTxt</name>
   <tag></tag>
   <elementGuidId>adec3714-a4ee-431f-b128-5ae9e1f1df2d</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${mobileNum}' or . = '${mobileNum}')]</locator>
