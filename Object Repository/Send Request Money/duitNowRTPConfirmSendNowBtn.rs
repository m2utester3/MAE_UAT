...
<MobileElementEntity>
   ...
   <name>duitNowRTPConfirmSendNowBtn</name>
   <tag></tag>
   <elementGuidId>c6072f77-eb68-4d5e-9511-422b8f668326</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (contains(@text, 'Send Now') or contains(., 'Send Now'))]</locator>
